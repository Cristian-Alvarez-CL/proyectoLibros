    ...
    return(
        ...
        <div className="container">
            <div className="text-center">
                <h2 className="section-heading text-uppercase">Equipo de Desarrolladores del Proyecto</h2>
                <h3 className="section-subheading text-muted">Generación Part Time XII</h3>
            </div>
            <div className="row">
                ...
                <div className="col-lg-4">
                    <div className="team-member">
                        <img className="mx-auto rounded-circle" src={fotoTeam5} alt="" />
                        <h4>Duglas Medina</h4>
                        <p className="text-muted">Estudiante 4Geeks Academy</p>
                        {/* <a className="btn btn-dark btn-social mx-2" href="#!"><i className="fab fa-twitter"></i></a>
                        <a className="btn btn-dark btn-social mx-2" href="#!"><i className="fab fa-facebook-f"></i></a>
